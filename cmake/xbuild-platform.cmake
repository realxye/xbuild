...
if (XBD_OPT_BUILD_PLATFORM STREQUAL "unknown")
    if (DEFINED WIN32)
        ...
        message(WARNING "Target platform is not defined, default to 'Windows'")
    else()
        if (CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
            set(XBD_OPT_BUILD_PLATFORM "macos")
            message(WARNING "Target platform is not defined, default to 'MacOS'")
        else()
            set(XBD_OPT_BUILD_PLATFORM "linux")
            message(WARNING "Target platform is not defined, default to 'Linux'")
        endif()
    endif()
endif()
