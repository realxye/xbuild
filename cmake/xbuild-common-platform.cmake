...
if(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    ...
    include($ENV{XBUILDROOT}/cmake/xbuild-platform-linux)
elseif(ANDROID)
    set(XBUILD_PLATFORM_ANDROID ON)
    include($ENV{XBUILDROOT}/cmake/xbuild-platform-android)
elseif(APPLE)
    if(IOS)
        set(XBUILD_PLATFORM_IOS ON)
        include($ENV{XBUILDROOT}/cmake/xbuild-platform-ios)
    else()
        set(XBUILD_PLATFORM_MACOS ON)
        include($ENV{XBUILDROOT}/cmake/xbuild-platform-macos)
    endif()
elseif(WIN32)
